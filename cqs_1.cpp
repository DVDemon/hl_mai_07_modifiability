...
auto main() -> int
{
    ...
    if (store.Save(3, "Message 3") == std::string("Message 3"))
        std::cout << "Added" << std::endl;
    if (store.Save(2, "Message 2") == std::string("Message 2"))
        std::cout << "Added" << std::endl;
    if (store.Save(1, "Message 1") == std::string("Message 1"))
        std::cout << "Added" << std::endl;
    if (store.Save(0, "Message 0") == std::string("Message 0"))
        std::cout << "Added" << std::endl;
    if (store.Save(3, "Message New") == std::string("Message New"))
        std::cout << "Added" << std::endl;
